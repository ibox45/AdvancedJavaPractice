...
public class Q11 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("bir sayi yazın");
        ...
        if(toplam==sayi){
            System.out.println("girmis oldugunuz "+sayi+ " mükemmel sayidir.");
        }else{
            System.out.println("girmis oldugunuz "+sayi+ "mukemmel sayi degildir");
        }
