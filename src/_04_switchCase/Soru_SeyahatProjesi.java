       ...
       case:1  ise
        ...
        switch (hedef) {
            ...
            case "FRANKFURT":
                ...
                switch (kisi) {
                    case 1:
                        ...
                        System.out.println("1 kisi icin bilet fiyati : " + (frUcret) + " EURO");

                        break;
                    case 2:
                        System.out.println("2 kisilik");
                        System.out.println("2 kisi icin bilet fiyati : " + (2 * frUcret) + " EURO");
                        break;
                    default:
                        System.out.println("hatali giris yaptiniz");
                        break;
            ...
            case "KOLN":
                ...
                System.out.println("Koln " + frUcret + " EURO");
                System.out.println("Kaç kişilik bilet istiyorsunuz? (Max 2 kişilik olabilir)");
                int kisi1 = scan.nextInt();
                switch (kisi1) {
                    case 1:
                        System.out.println(" 1 kişilik ");
                        System.out.println("1 kisi icin bilet fiyati : " + (klUcret) + " EURO");

                        break;
                    case 2:
                        System.out.println("2 kisilik");
                        System.out.println("2 kisi icin bilet fiyati : " + (2 * klUcret) + " EURO");
                        break;
                    default:
                        System.out.println("hatali giris yaptiniz");
                        break;
