...
public class Q11 {
    ...
    /* TASK :
      ...
      //  System.out.println("tarihi gün , ay , ve yıl olarak giriniz\nLütfen günü giriniz: ");
      //  String gun=scan.next();
      //  System.out.println("Lütfen ayı giriniz:");
      //  String ay=scan.next();
      //  System.out.println("Lütfen yılı giriniz:");
      //  String yil=scan.next();
      //  String gunAyYil=gun+"."+ay+"."+yil;
      //  String ayGunYil=ay+"."+gun+"."+yil;
      //  String yilAyGun=yil+"."+ay+"."+gun;
      //  System.out.println("gunAyYil = " + gunAyYil);
      //  System.out.println("ayGunYil = " + ayGunYil);
      //  System.out.println("yilAyGun = " + yilAyGun);
